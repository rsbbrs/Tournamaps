...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "SmashBros Tournament Locator.Android.dll" comes first in this list. */
		"SmashBros Tournament Locator.Android.dll",
		"FormsViewGroup.dll",
		"SmashBros Tournament Locator.dll",
